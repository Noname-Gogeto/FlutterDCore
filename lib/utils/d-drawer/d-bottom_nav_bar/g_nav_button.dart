...
class DNavButton extends StatefulWidget {
  const DNavButton({
    Key? key,
    this.icon,
    this.iconSize,
  ...
  @override
  State<DNavButton> createState() => _DNavButtonState();
}

class _DNavButtonState extends State<DNavButton> with TickerProviderStateMixin {
  late bool _expanded;
        ...
        child: Container(
          ...
          child: AnimatedContainer(
            ...
            decoration: BoxDecoration(
              boxShadow: widget.active! ? widget.activeShadow : widget.shadow,
            ...
            child: FittedBox(
              ...
              child: Builder(
                builder: (_) {
                  if (widget.tabStyle == NavStyle.row) {
                    return Stack(
                      children: [
                        if (widget.text!.data != '')
                  ...
                  if (widget.tabStyle == NavStyle.column) {
                    return Column(
                      children: [
                        icon,
                          ...
                          Container(
                            ...
                            child: Text(
                              ...
                              style: TextStyle(
                                ...
                                fontWeight: getFontWeight(fontWeightType: DTextType.defaultText),
